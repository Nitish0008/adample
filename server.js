...
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to send email. Please check server credentials.' })
  }
})
...
if (process.env.NODE_ENV === 'production') {
  ...
  app.get('/', (req, res) => {
    res.send('Server is running in development mode. API is active.')
  })
}
